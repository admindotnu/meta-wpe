DESCRIPTION = "Gstreamer plugin to satisfy all your basic cenc decryption needs"
...
DEPENDS = "wpeframework-clientlibraries gstreamer1.0 gstreamer1.0-plugins-base"
